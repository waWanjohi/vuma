...
List<Message> chats = [
  ...
  Message(
    sender: john,
    time: '3:30 PM',
    text: 'Hey, how\'s it going? What did you do today? john ',
    isLiked: false,
    unread: false,
  ),
  Message(
  ...
  Message(
    sender: greg,
    time: '11:30 AM',
    text: 'Hey, how\'s it going? What did you do today? greg',
    isLiked: false,
    unread: false,
  ),
];
...
List<Message> messages = [
  ...
  Message(
    sender: currentUser,
    time: '4:30 PM',
    text: 'me: Just walked my doge. She was super duper cute. The best pupper!!',
    isLiked: false,
    unread: true,
  ),
  Message(
  ...
  Message(
    sender: currentUser,
    time: '2:30 PM',
    text: 'me: Nice! What kind of food did you eat?',
    isLiked: false,
    unread: true,
  ),
  Message(
